...
namespace POGOLib.Pokemon
{
    ...
    public class Map
    {
        ...
        {
            return GetSpawnPointsSortedByDistance(_session.Player.Coordinate, filter);
        }

        public List<SpawnPoint> GetSpawnPointsSortedByDistance(GeoCoordinate point, Func < SpawnPoint, bool> filter = null)
        {
            ...
            sorted.Sort((p1, p2) =>
            {
                ...
                var distance1 = p1Coordinate.GetDistanceTo(point);
                var distance2 = p2Coordinate.GetDistanceTo(point);
        ...
        {
            return GetCatchablePokemonsSortedByDistance(_session.Player.Coordinate, filter);
        }

        public List<MapPokemon> GetCatchablePokemonsSortedByDistance(GeoCoordinate point, Func<MapPokemon, bool> filter = null)
        {
        ...
        {
            return GetWildPokemonsSortedByDistance(_session.Player.Coordinate, filter);
        }

        public List<WildPokemon> GetWildPokemonsSortedByDistance(GeoCoordinate point, Func<WildPokemon, bool> filter = null)
        {
        ...
        {
            return GetFortsSortedByDistance(_session.Player.Coordinate, filter);
        }

        public List<FortData> GetFortsSortedByDistance(GeoCoordinate point, Func<FortData, bool> filter = null)
        {
            ...
            sorted.Sort((f1, f2) =>
            {
                ...
                var distance1 = f1Coordinate.GetDistanceTo(point);
                var distance2 = f2Coordinate.GetDistanceTo(point);
